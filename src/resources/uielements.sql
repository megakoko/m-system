...
SELECT 02, 'Pre', 'main', NULL, 'lineedit', 'Вводная часть' , NULL UNION 
SELECT 03, 'HospAim', 'main', NULL, 'combobox', 'Цель госпитализации' , NULL UNION 	-- multivalue
SELECT 04, 'Complaints', 'main', NULL, 'lineedit', 'Жалобы' , NULL UNION 
SELECT 05, 'AA_FT', 'main', NULL, 'lineedit', 'Анамнез болезни' , NULL UNION 
SELECT 16000, 'StatusLocalis', 'main', NULL, 'lineedit', 'Status localis' , NULL UNION 
SELECT 16010, 'Extra', 'main', NULL, 'lineedit', 'Дополнительно' , NULL UNION 
SELECT 16020, 'EntranceDiagnosis', 'main', NULL, 'lineedit', 'Ds.', NULL ; 
...
SELECT 20, 'PA_PD', 'PA', NULL, 'lineedit', 'Перенесённые заболевания' , NULL UNION 
SELECT 30, 'PA_TO', 'PA', NULL, 'lineedit', 'Травмы и операции' , NULL UNION 
SELECT 40, 'PA_VH', 'PA', NULL, 'lineedit', 'Вирусный гепатит' , NULL UNION 
SELECT 50, 'PA_Tu', 'PA', NULL, 'lineedit', 'Туберкулёз' , NULL UNION 
SELECT 60, 'PA_VD', 'PA', NULL, 'lineedit', 'Венерические заболевания' , NULL UNION 
SELECT 70, 'PA_PM', 'PA', NULL, 'lineedit', 'Сахарный диабет' , NULL UNION 
SELECT 80, 'PA_EA', 'PA', NULL, 'combobox', 'Эпидемиологический анамнез' , NULL UNION 
SELECT 90, 'PA_AA', 'PA', NULL, 'lineedit', 'Аллергологический анамнез' , NULL UNION 
SELECT 100, 'PA_HT', 'PA', NULL, 'lineedit', 'Гемотрансфузии в анамнезе' , NULL UNION 
SELECT 110, 'PA_UI', 'PA', NULL, 'combobox', 'Привычные интоксикации' , NULL UNION 
SELECT 120, 'PA_AH', 'PA', NULL, 'lineedit', 'Наследственность' , NULL UNION 
SELECT 130, 'PA_FS', 'PA', NULL, 'lineedit', 'Семейное положение' , NULL UNION 
SELECT 140, 'PA_UP', 'PA', NULL, 'combobox', 'Условия проживания' , NULL UNION 
SELECT 150, 'PA_OGA', 'PA', NULL, 'lineedit', 'Акушерско-гинекологический анамнез' , NULL UNION 
SELECT 160, 'PA_M', 'PA', NULL, 'lineedit', 'Menses' , NULL UNION 
SELECT 170, 'PA_exp', 'PA', NULL, 'combobox', 'Страховой анамнез' , NULL UNION 
SELECT 180, 'PAd', 'PA', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
--SELECT 1080, 'US_CT', 'USall', NULL, 'combobox', 'Конституциональный тип' , NULL UNION 
SELECT 1090, 'US_MB', 'USall', NULL, 'lineedit', 'Масса тела, кг' , NULL UNION 
SELECT 1100, 'US_Stature', 'USall', NULL, 'lineedit', 'Рост, см' , NULL UNION 
SELECT 1110, 'US_TB', 'USall', NULL, 'lineedit', 'Температура тела, °C' , NULL UNION 
...
SELECT 1150, 'US_E', 'USall', NULL, 'lineedit', 'Отеки' , NULL UNION 
SELECT 1160, 'US_S', 'USall', NULL, 'container', 'Придатки кожи' , NULL UNION 
--SELECT 1170, 'US_Sd', 'USall', NULL, 'combobox', NULL , NULL UNION 
SELECT 1180, 'US_SHt', 'US_S', NULL, 'lineedit', 'Волосы' , NULL UNION 
SELECT 1190, 'US_SNt', 'US_S', NULL, 'lineedit', 'Ногти' , NULL UNION 
SELECT 1200, 'US_SMt', 'US_S', NULL, 'lineedit', 'Молочные железы' , NULL UNION 
...
SELECT 1310, 'USd', 'USall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 3020, 'MSSS', 'MSSall', NULL, 'lineedit', 'Костные структуры' , NULL UNION 
SELECT 3030, 'MSSM', 'MSSall', NULL, 'container', 'Мышечная система' , NULL UNION 
SELECT 3040, 'NS_dva', 'MSSM', NULL, 'lineedit', 'Атрофия мышц' , NULL UNION 
SELECT 3050, 'NS_dvg', 'MSSM', NULL, 'lineedit', 'Истинная гипертрофия мышц' , NULL UNION 
SELECT 3060, 'NS_dvp', 'MSSM', NULL, 'lineedit', 'Псевдогипертрофии' , NULL UNION 
SELECT 3070, 'NS_dvf', 'MSSM', NULL, 'lineedit', 'Фибриллярные и фасцикулярные' , NULL UNION 
SELECT 3080, 'NS_dvr', 'MSSM', NULL, 'lineedit', 'Ретракции и контрактуры' , NULL UNION 
SELECT 3090, 'NS_dvo', 'MSSM', NULL, 'lineedit', 'Объем движений в конечностях' , NULL UNION 
SELECT 3100, 'NS_dvs', 'MSSM', NULL, 'lineedit', 'Сила мышц дистальных и' , NULL UNION 
SELECT 3110, 'NS_dvt', 'MSSM', NULL, 'lineedit', 'Тонус мышц' , NULL UNION 
SELECT 3120, 'MSSJ', 'MSSall', NULL, 'container', 'Суставы' , NULL UNION 
SELECT 3130, 'MSSJ_1', 'MSSJ', NULL, 'lineedit', 'Конфигурация суставов' , 'Конфигурация' UNION 
SELECT 3140, 'MSSJ_2', 'MSSJ', NULL, 'lineedit', 'Болезненность суставов при пальпации' , 'Болезненность при пальпации' UNION 
SELECT 3150, 'MSSJ_3', 'MSSJ', NULL, 'lineedit', 'Активные движения суставов' , 'Активные движения' UNION 
SELECT 3160, 'MSSJ_4', 'MSSJ', NULL, 'lineedit', 'Пассивные движения суставов' , 'Пассивные движения' UNION 
SELECT 3170, 'MSSd', 'MSSall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 4020, 'NeckF', 'Neckall', NULL, 'lineedit', 'Форма шеи' , NULL UNION 
...
SELECT 4100, 'NeckD', 'Neckall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 5020, 'NS_cnzo', 'OVall', NULL, 'lineedit', 'Острота зрения' , NULL UNION 
SELECT 5030, 'NS_cnzc', 'OVall', NULL, 'lineedit', 'Цветоощущение' , NULL UNION 
SELECT 5040, 'NS_cnzp', 'OVall', NULL, 'lineedit', 'Поля зрения' , NULL UNION 
SELECT 5050, 'NS_cngd', 'OVall', NULL, 'lineedit', 'Диплопия' , NULL UNION 
SELECT 5060, 'US_OVemot', 'OVall', NULL, 'lineedit', 'Движения глазных яблок' , NULL UNION 
...
SELECT 5120, 'US_OVd', 'OVall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 6030, 'US_RAFRM', 'RAall', NULL, 'lineedit', 'Частота дыхательных движений' , NULL UNION 
...
SELECT 6060, 'US_RAP', 'RAall', NULL, 'lineedit', 'Пальпация грудной клетки' , NULL UNION 
SELECT 6070, 'US_RAPS', 'RAall', NULL, 'lineedit', 'Перкуторный звук' , NULL UNION 
SELECT 6080, 'US_RAA', 'RAall', NULL, 'combobox', 'Аускультативно' , NULL UNION 
SELECT 6090, 'US_RAW', 'RAall', NULL, 'lineedit', 'Хрипы' , NULL UNION 
...
SELECT 6120, 'US_RAd', 'RAall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 7045, 'CSSHB_', 'CVSall', NULL, 'lineedit', 'Частота сердечных сокращений' , NULL UNION 
SELECT 7050, 'CVSP', 'CVSall', NULL, 'combobox', 'Пульс' , NULL UNION 
SELECT 7055, 'CVSP_', 'CVSall', NULL, 'combobox', 'Частота пульса' , NULL UNION 
SELECT 7060, 'CVSJS', 'CVSall', NULL, 'lineedit', 'Дефицит пульса' , NULL UNION 
SELECT 7070, 'CVSAP', 'CVSall', NULL, 'container', 'Артериальное давление' , NULL UNION 
SELECT 7080, 'CVSAPRTt', 'CVSAP', NULL, 'lineedit', 'Артериальное давление на правой верхней конечности' , 'на правой верхней конечности' UNION 
SELECT 7090, 'CVSAPLTt', 'CVSAP', NULL, 'lineedit', 'Артериальное давление на левой верхней конечности' , 'на левой верхней конечности' UNION 
SELECT 7100, 'CVSAPRBt', 'CVSAP', NULL, 'lineedit', 'Артериальное давление на правой нижней конечности' , 'на правой нижней конечности' UNION 
SELECT 7110, 'CVSAPLBt', 'CVSAP', NULL, 'lineedit', 'Артериальное давление на левой нижней конечности' , 'на левой нижней конечности' UNION 
SELECT 7120, 'CVSAT', 'CVSall', NULL, 'combobox', 'Верхушечный толчок' , NULL UNION 
SELECT 7130, 'CVSHT', 'CVSall', NULL, 'lineedit', 'Сердечный толчок' , NULL UNION 
...
SELECT 7180, 'CVSCCARo', 'CVSCCAR', NULL, 'lineedit', 'Правая общая сонная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7220, 'CVSCCALo', 'CVSCCAL', NULL, 'lineedit', 'Левая общая сонная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7250, 'CVSCARo', 'CVSCAR', NULL, 'lineedit', 'Правая подключичная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7280, 'CVSCALo', 'CVSCAL', NULL, 'lineedit', 'Левая подключичная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7320, 'CVSBARo', 'CVSBAR', NULL, 'lineedit', 'Правая плечевая артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7360, 'CVSBALo', 'CVSBAL', NULL, 'lineedit', 'Левая плечевая артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7390, 'CVSRARo', 'CVSRAR', NULL, 'lineedit', 'Правая лучевая артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7420, 'CVSRALo', 'CVSRAL', NULL, 'lineedit', 'Левая лучевая артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7460, 'CVSAAo', 'CVSAA', NULL, 'lineedit', 'Брюшная аорта (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7500, 'CVSFARo', 'CVSFAR', NULL, 'lineedit', 'Правая общая бедренная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7540, 'CVSFALo', 'CVSFAL', NULL, 'lineedit', 'Левая общая бедренная артерия (дополнительно)' , 'дополнительно' UNION --
...
SELECT 7580, 'CVSPARo', 'CVSPAR', NULL, 'lineedit', 'Правая подколенная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7620, 'CVSPALo', 'CVSPAL', NULL, 'lineedit', 'Левая подколенная артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7650, 'CVSRFARo', 'CVSRFAR', NULL, 'lineedit', 'Правая артерия тыла стопы (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7680, 'CVSRFALo', 'CVSRFAL', NULL, 'lineedit', 'Левая артерия тыла стопы (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7710, 'CVSPTARo', 'CVSPTAR', NULL, 'lineedit', 'Правая задняя большеберцовая артерия (дополнительно)' , 'дополнительно' UNION 
...
SELECT 7740, 'CVSPTALo', 'CVSPTAL', NULL, 'lineedit', 'Левая задняя большеберцовая артерия (дополнительно)' , 'дополнительно' UNION 
SELECT 7750, 'CVSSVT', 'CVSall', NULL, 'lineedit', 'Подкожные вены верхних конечностей' , NULL UNION 
SELECT 7760, 'CVSSVB', 'CVSall', NULL, 'lineedit', 'Подкожные вены нижних конечностей' , NULL UNION 
SELECT 7770, 'CVSCE', 'CVSall', NULL, 'container', 'Окружность конечностей' , NULL UNION 
SELECT 7780, 'CVSCEd1', 'CVSCE', NULL, 'lineedit', 'Окружность правой верхней конечности в средней трети плеча' , 'правой верхней в средней трети плеча' UNION 
SELECT 7790, 'CVSCEd2', 'CVSCE', NULL, 'lineedit', 'Окружность левой верхней конечности в средней трети плеча' , 'левой верхней в средней трети плеча' UNION 
SELECT 7800, 'CVSCEd3', 'CVSCE', NULL, 'lineedit', 'Окружность правой верхней конечности в средней трети предплечья' , 'правой верхней в средней трети предплечья' UNION 
SELECT 7810, 'CVSCEd4', 'CVSCE', NULL, 'lineedit', 'Окружность левой верхней конечности в средней трети предплечья' , 'левой верхней в средней трети предплечья' UNION 
SELECT 7820, 'CVSCEd5', 'CVSCE', NULL, 'lineedit', 'Окружность правой нижней конечности в средней трети бедра' , 'правой нижней в средней трети бедра' UNION 
SELECT 7830, 'CVSCEd6', 'CVSCE', NULL, 'lineedit', 'Окружность левой нижней конечности в средней трети бедра' , 'левой нижней в средней трети бедра' UNION 
SELECT 7840, 'CVSCEd7', 'CVSCE', NULL, 'lineedit', 'Окружность правой нижней конечности в средней трети голени' , 'правой нижней в средней трети голени' UNION 
SELECT 7850, 'CVSCEd8', 'CVSCE', NULL, 'lineedit', 'Окружность левой нижней конечности в средней трети голени' , 'левой нижней в средней трети голени' UNION 
SELECT 7860, 'CVSd', 'CVSall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 9040, 'NS_ha', 'NS_os', NULL, 'lineedit', 'Головная боль' , NULL UNION 
SELECT 9050, 'NS_go', 'NS_os', NULL, 'lineedit', 'Головокружение' , NULL UNION 
SELECT 9060, 'NS_rv', 'NS_os', NULL, 'lineedit', 'Рвота без предшествующего периода тошноты' , NULL UNION 
SELECT 9070, 'NS_cnzz', 'NS_os', NULL, 'lineedit', 'Зрительные галлюцинации' , NULL UNION 
SELECT 9080, 'NS_cnsg', 'NS_os', NULL, 'lineedit', 'Слуховые галлюцинации' , NULL UNION 
SELECT 9090, 'NS_cnog', 'NS_os', NULL, 'lineedit', 'Обонятельные галлюцинации' , NULL UNION 
SELECT 9100, 'NS_cnosg', 'NS_os', NULL, 'lineedit', 'Осязательные галлюцинации' , NULL UNION 
SELECT 9110, 'NS_osd', 'NS_os', NULL, 'lineedit', 'Общемозговые симптомы (дополнительно)' , 'дополнительно' UNION 
SELECT 9120, 'NS_ms', 'NSall', NULL, 'container', 'Менингеальные симптомы' , NULL UNION 
SELECT 9130, 'NS_mp', 'NS_ms', NULL, 'lineedit', 'Менингеальная поза' , NULL UNION 
SELECT 9140, 'NS_hy', 'NS_ms', NULL, 'lineedit', 'Общая кожная гиперэстезия' , NULL UNION 
...
SELECT 9300, 'NS_syr', 'NS_ms', NULL, 'lineedit', 'Большой родничок' , NULL UNION 
SELECT 9310, 'NS_msd', 'NS_ms', NULL, 'lineedit', 'Менингеальные симптомы (дополнительно)' , 'дополнительно' UNION 
...
SELECT 9340, 'NS_cnoan', 'NS_cno', NULL, 'lineedit', 'Аносмия' , NULL UNION 
SELECT 9350, 'NS_cnohy', 'NS_cno', NULL, 'lineedit', 'Гипосмия' , NULL UNION 
SELECT 9360, 'NS_cnohyp', 'NS_cno', NULL, 'lineedit', 'Гиперосмия' , NULL UNION 
SELECT 9370, 'NS_cnodys', 'NS_cno', NULL, 'lineedit', 'Дизосмия' , NULL UNION 
SELECT 9380, 'NS_cnod', 'NS_cno', NULL, 'lineedit', 'Обонятельный нерв (дополнительно)' , 'дополнительно' UNION 
SELECT 9390, 'NS_cnz', 'NS_cn', NULL, 'container', 'Зрительный нерв' , NULL UNION 
SELECT 9400, 'NS_cnzg', 'NS_cnz', NULL, 'lineedit', 'Глазное дно' , NULL UNION 
SELECT 9410, 'NS_cnzd', 'NS_cnz', NULL, 'lineedit', 'Зрительный нерв (дополнительно)' , 'дополнительно' UNION 
SELECT 9420, 'NS_cng', 'NS_cn', NULL, 'container', 'Глазодвигательные нервы' , NULL UNION 
SELECT 9430, 'NS_cngs', 'NS_cng', NULL, 'lineedit', 'Ширина и равномерность глазных щелей' , NULL UNION 
SELECT 9440, 'NS_cngr', 'NS_cng', NULL, 'lineedit', 'Положение и объем движений глазных яблок' , NULL UNION 
...
SELECT 9480, 'NS_cngdop', 'NS_cng', NULL, 'lineedit', 'Глазодвигательные нервы (дополнительно)' , 'дополнительно' UNION 
SELECT 9490, 'NS_cnt', 'NS_cn', NULL, 'container', 'Тройничный нерв' , NULL UNION 
SELECT 9500, 'NS_cntm', 'NS_cnt', NULL, 'lineedit', 'Объем движений нижней челюсти' , NULL UNION 
SELECT 9510, 'NS_cntz', 'NS_cnt', NULL, 'lineedit', 'Напряжение и трофика жевательных мышц' , NULL UNION 
SELECT 9520, 'NS_cntb', 'NS_cnt', NULL, 'lineedit', 'Боли и парестезии в области лица' , NULL UNION 
SELECT 9530, 'NS_cntt', 'NS_cnt', NULL, 'lineedit', 'Болевые точки' , NULL UNION 
SELECT 9540, 'NS_cntc', 'NS_cnt', NULL, 'lineedit', 'Чувствительность кожи лица' , NULL UNION 
...
SELECT 9590, 'NS_cntd', 'NS_cnt', NULL, 'lineedit', 'Тройничный нерв (дополнительно)' , 'дополнительно' UNION 
SELECT 9600, 'NS_cnl', 'NS_cn', NULL, 'container', 'Лицевой нерв' , NULL UNION 
SELECT 9610, 'NS_cnlm', 'NS_cnl', NULL, 'lineedit', 'Иннервация мимической мускулатуры' , NULL UNION 
SELECT 9620, 'NS_cnlt', 'NS_cnl', NULL, 'lineedit', 'Чувствительность передних 2/3 языка' , NULL UNION 
SELECT 9630, 'NS_cnlh', 'NS_cnl', NULL, 'lineedit', 'Гиперакузия' , NULL UNION 
SELECT 9640, 'NS_cnls', 'NS_cnl', NULL, 'lineedit', 'Слезотечение' , NULL UNION 
...
SELECT 9670, 'NS_cnll', 'NS_cnl', NULL, 'lineedit', 'Лагофтальм' , NULL UNION 
SELECT 9680, 'NS_cnld', 'NS_cnl', NULL, 'lineedit', 'Лицевой нерв (дополнительно)' , 'дополнительно' UNION 
...
SELECT 9710, 'NS_cnsh', 'NS_cns', NULL, 'lineedit', 'Гипакузия' , NULL UNION 
SELECT 9720, 'NS_cnsz', 'NS_cns', NULL, 'lineedit', 'Гиперакузия' , NULL UNION 
SELECT 9730, 'NS_cnss', 'NS_cns', NULL, 'lineedit', 'Шум в ушах' , NULL UNION 
SELECT 9740, 'NS_cnsn', 'NS_cns', NULL, 'lineedit', 'Нистагм' , NULL UNION 
SELECT 9750, 'NS_cnsd', 'NS_cns', NULL, 'lineedit', 'Слуховой и вестибулярный нервы (дополнительно)' , 'дополнительно' UNION 
SELECT 9760, 'NS_cny', 'NS_cn', NULL, 'container', 'Языкоглоточный и блуждающий нервы' , NULL UNION 
SELECT 9770, 'NS_cnym', 'NS_cny', NULL, 'lineedit', 'Мягкое небо' , NULL UNION 
SELECT 9780, 'NS_cnyl', 'NS_cny', NULL, 'lineedit', 'Положение язычка' , NULL UNION 
SELECT 9790, 'NS_cnyc', 'NS_cny', NULL, 'lineedit', 'Чувствительность' , NULL UNION 
SELECT 9800, 'NS_cnyg', 'NS_cny', NULL, 'lineedit', 'Глоточные рефлексы' , NULL UNION 
SELECT 9810, 'NS_cnyn', 'NS_cny', NULL, 'lineedit', 'Небные рефлексы' , NULL UNION 
SELECT 9820, 'NS_cnyo', 'NS_cny', NULL, 'lineedit', 'Глотание' , NULL UNION 
SELECT 9830, 'NS_cnyf', 'NS_cny', NULL, 'lineedit', 'Фонация' , NULL UNION 
SELECT 9840, 'NS_cnya', 'NS_cny', NULL, 'lineedit', 'Артикуляция' , NULL UNION 
SELECT 9850, 'NS_cnyi', 'NS_cny', NULL, 'lineedit', 'Иннервация задней трети языка' , NULL UNION 
SELECT 9860, 'NS_cnys', 'NS_cny', NULL, 'lineedit', 'Саливация' , NULL UNION 
SELECT 9870, 'NS_cnyp', 'NS_cny', NULL, 'lineedit', 'Парасимпатическая иннервация внутренних органов' , NULL UNION 
SELECT 9880, 'NS_cnyd', 'NS_cny', NULL, 'lineedit', 'Языкоглоточный и блуждающий нервы (дополнительно)' , 'дополнительно' UNION 
SELECT 9890, 'NS_cnd', 'NSall', NULL, 'container', 'Добавочный нерв' , NULL UNION 
SELECT 9900, 'NS_cndp', 'NS_cnd', NULL, 'lineedit', 'Положение плеч, лопаток и головы в покое' , NULL UNION 
SELECT 9910, 'NS_cndm', 'NS_cnd', NULL, 'lineedit', 'Поднимание плеч, повороты головы' , NULL UNION 
SELECT 9920, 'NS_cnds', 'NS_cnd', NULL, 'lineedit', 'Напряжение, трофика грудино-ключично-сосцевидной мышцы и трапециевидной мышцы' , NULL UNION 
SELECT 9930, 'NS_cndk', 'NS_cnd', NULL, 'lineedit', 'Кривошея' , NULL UNION 
SELECT 9940, 'NS_cndd', 'NS_cnd', NULL, 'lineedit', 'Добавочный нерв (дополнительно)' , 'дополнительно' UNION 
SELECT 9950, 'NS_cnpod', 'NSall', NULL, 'container', 'Подъязычный нерв' , NULL UNION 
SELECT 9960, 'NS_cnpodg', 'NS_cnpod', NULL, 'lineedit', 'Положение языка в полости рта и при высовывании' , NULL UNION 
SELECT 9970, 'NS_cnpoda', 'NS_cnpod', NULL, 'lineedit', 'Атрофия (гипотрофия) и фибриллярные подергивания в мышцах языка' , NULL UNION 
SELECT 9980, 'NS_cnpodr', 'NS_cnpod', NULL, 'lineedit', 'Дизартрия' , NULL UNION 
SELECT 9990, 'NS_cnpodd', 'NS_cnpod', NULL, 'lineedit', 'Подъязычный нерв (дополнительно)' , 'дополнительно' UNION 
SELECT 10000, 'NS_bu', 'NSall', NULL, 'container', 'Бульбарный и псевдобульбарный синдромы' , NULL UNION 
SELECT 10010, 'NS_bud', 'NS_bu', NULL, 'lineedit', 'Дизартрия' , NULL UNION 
SELECT 10020, 'NS_buf', 'NS_bu', NULL, 'lineedit', 'Дисфония' , NULL UNION 
SELECT 10030, 'NS_bug', 'NS_bu', NULL, 'lineedit', 'Дисфагия' , NULL UNION 
...
SELECT 10110, 'NS_budop', 'NS_bu', NULL, 'lineedit', 'Бульбарный и псевдобульбарный синдромы (дополнительно)' , 'дополнительно' UNION 
...
SELECT 10140, 'NS_dvl', 'NS_dv', NULL, 'lineedit', 'Параличи и парезы конечностей' , NULL UNION 
SELECT 10150, 'NS_dvd', 'NS_dv', NULL, 'lineedit', 'Двигательная сфера (дополнительно)' , 'дополнительно' UNION 
...
SELECT 10280, 'NS_resd', 'NS_res', NULL, 'lineedit', 'Сухожильные и надкостничные рефлексы (дополнительно)' , 'дополнительно' UNION 
SELECT 10290, 'NS_rec', 'NSall', NULL, 'container', 'Кожные рефлексы' , NULL UNION 
SELECT 10300, 'NS_reca', 'NS_rec', NULL, 'lineedit', 'Брюшные рефлексы' , NULL UNION 
SELECT 10310, 'NS_recc', 'NS_rec', NULL, 'lineedit', 'Кремастерные рефлексы' , NULL UNION 
SELECT 10320, 'NS_recn', 'NS_rec', NULL, 'lineedit', 'Анальный рефлекс' , NULL UNION 
SELECT 10330, 'NS_recy', 'NS_rec', NULL, 'lineedit', 'Ягодичный рефлекс' , NULL UNION 
SELECT 10340, 'NS_recp', 'NS_rec', NULL, 'lineedit', 'Подошвенный рефлекс' , NULL UNION 
SELECT 10350, 'NS_recd', 'NS_rec', NULL, 'lineedit', 'Кожные рефлексы (дополнительно)' , 'дополнительно' UNION 
...
SELECT 10410, 'NS_resld', 'NS_resl', NULL, 'lineedit', 'Рефлексы со слизистых (дополнительно)' , 'дополнительно' UNION 
SELECT 10420, 'NS_rep', 'NSall', NULL, 'container', 'Патологические рефлексы' , NULL UNION 
SELECT 10430, 'NS_repr', 'NS_rep', NULL, 'lineedit', 'Кистевой рефлекс Россолимо' , NULL UNION 
SELECT 10440, 'NS_repj', 'NS_rep', NULL, 'lineedit', 'Кистевой рефлекс Жуковского' , NULL UNION 
SELECT 10450, 'NS_repi', 'NS_rep', NULL, 'lineedit', 'Кистевой рефлекс Якобсона-Ласка' , NULL UNION 
SELECT 10460, 'NS_reps', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Россолимо' , NULL UNION 
SELECT 10470, 'NS_repj2', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Жуковского' , NULL UNION 
SELECT 10480, 'NS_repb1', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Бехтерева-1' , NULL UNION 
SELECT 10490, 'NS_repb2', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Бехтерева-2' , NULL UNION 
SELECT 10500, 'NS_repba', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Бабинского' , NULL UNION 
SELECT 10510, 'NS_repo', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Оппенгейма' , NULL UNION 
SELECT 10520, 'NS_repg', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Гордона' , NULL UNION 
SELECT 10530, 'NS_reph', 'NS_rep', NULL, 'lineedit', 'Стопный рефлекс Шеффера' , NULL UNION 
SELECT 10540, 'NS_repbe', 'NS_rep', NULL, 'lineedit', 'Симптом Бехтерева-Мари-Фуа' , NULL UNION 
SELECT 10550, 'NS_repsh', 'NS_rep', NULL, 'lineedit', 'Тибиальный феномен Штрюмпелля' , NULL UNION 
SELECT 10560, 'NS_repp', 'NS_rep', NULL, 'lineedit', 'Пронаторная синкинезия' , NULL UNION 
SELECT 10570, 'NS_repra', 'NS_rep', NULL, 'lineedit', 'Радиальная синкинезия' , NULL UNION 
SELECT 10580, 'NS_repsy', 'NS_rep', NULL, 'lineedit', 'Синкинезия Раймиста' , NULL UNION 
SELECT 10590, 'NS_repd', 'NS_rep', NULL, 'lineedit', 'Патологические рефлексы (дополнительно)' , 'дополнительно' UNION 
SELECT 10600, 'NS_co', 'NSall', NULL, 'container', 'Координация движений' , NULL UNION 
SELECT 10610, 'NS_coa', 'NS_co', NULL, 'lineedit', 'Атаксия' , NULL UNION 
SELECT 10620, 'NS_cot', 'NS_co', NULL, 'lineedit', 'Тремор' , NULL UNION 
SELECT 10630, 'NS_con', 'NS_co', NULL, 'lineedit', 'Нистагм' , NULL UNION 
SELECT 10640, 'NS_cos', 'NS_co', NULL, 'lineedit', 'Скандированная речь' , NULL UNION 
SELECT 10650, 'NS_cor', 'NS_co', NULL, 'lineedit', 'Проба Ромберга' , NULL UNION 
SELECT 10660, 'NS_copn', 'NS_co', NULL, 'lineedit', 'Локомоторная пальценосовая проба' , NULL UNION 
SELECT 10670, 'NS_copk', 'NS_co', NULL, 'lineedit', 'Локомоторная пяточноколенная проба' , NULL UNION 
SELECT 10680, 'NS_cosh', 'NS_co', NULL, 'combobox', 'Проба Шильдера' , NULL UNION 
SELECT 10690, 'NS_coi', 'NS_co', NULL, 'lineedit', 'Пробы на адиадохокинез' , NULL UNION 
SELECT 10700, 'NS_coas', 'NS_co', NULL, 'lineedit', 'Пробы на асинергию' , NULL UNION 
SELECT 10710, 'NS_cohy', 'NS_co', NULL, 'lineedit', 'Пробы на гиперметрию' , NULL UNION 
SELECT 10720, 'NS_cost', 'NS_co', NULL, 'combobox', 'Феномен Стюарта-Холмса' , NULL UNION 
SELECT 10730, 'NS_cod', 'NS_co', NULL, 'lineedit', 'Координация движений (дополнительно)' , 'дополнительно' UNION 
SELECT 10740, 'NS_chu', 'NSall', NULL, 'container', 'Чувствительность' , NULL UNION 
SELECT 10750, 'NS_chub', 'NS_chu', NULL, 'lineedit', 'Болевая чувствительность' , NULL UNION 
SELECT 10760, 'NS_chut', 'NS_chu', NULL, 'lineedit', 'Температурная чувствительность' , NULL UNION 
SELECT 10770, 'NS_chuta', 'NS_chu', NULL, 'lineedit', 'Тактильная чувствительность' , NULL UNION 
...
SELECT 10830, 'NS_chubt', 'NS_chu', NULL, 'lineedit', 'Болевые точки' , NULL UNION 
SELECT 10840, 'NS_chuz', 'NS_chu', NULL, 'lineedit', 'Зоны Захарьина-Геда' , NULL UNION 
SELECT 10850, 'NS_chug', 'NS_chu', NULL, 'lineedit', 'Глубокая чувствительность' , NULL UNION 
SELECT 10860, 'NS_chud', 'NS_chu', NULL, 'lineedit', 'Чувствительность (дополнительно)' , 'дополнительно' UNION 
SELECT 10870, 'NS_ve', 'NSall', NULL, 'container', 'Вегетативно-трофическая сфера' , NULL UNION 
SELECT 10880, 'NS_vet', 'NS_ve', NULL, 'lineedit', 'Трофика кожи' , NULL UNION 
SELECT 10890, 'NS_ven', 'NS_ve', NULL, 'lineedit', 'Состояние ногтей и оволосение' , NULL UNION 
SELECT 10900, 'NS_vee', 'NS_ve', NULL, 'lineedit', 'Дермографизм' , NULL UNION 
SELECT 10910, 'NS_ves', 'NS_ve', NULL, 'lineedit', 'Солярный рефлекс' , NULL UNION 
SELECT 10920, 'NS_vec', 'NS_ve', NULL, 'lineedit', 'Клиноортостатическая проба' , NULL UNION 
SELECT 10930, 'NS_veg', 'NS_ve', NULL, 'lineedit', 'Глазосердечный рефлекс Даньини-Ашнера' , NULL UNION 
SELECT 10940, 'NS_vepi', 'NS_ve', NULL, 'lineedit', 'Пиломоторный рефлекс' , NULL UNION 
SELECT 10950, 'NS_ved', 'NS_ve', NULL, 'lineedit', 'Вегетативно-трофическая сфера (дополнительно)' , 'дополнительно' UNION 
SELECT 10960, 'NS_vi', 'NSall', NULL, 'container', 'Высшие корковые функции' , NULL UNION 
SELECT 10970, 'NS_vig', 'NS_vi', NULL, 'lineedit', 'Гнозис' , NULL UNION 
SELECT 10980, 'NS_vip', 'NS_vi', NULL, 'lineedit', 'Праксис' , NULL UNION 
SELECT 10990, 'NS_vir', 'NS_vi', NULL, 'lineedit', 'Речь' , NULL UNION 
SELECT 11000, 'NS_vis', 'NS_vi', NULL, 'lineedit', 'Письмо, чтение, счет' , NULL UNION 
SELECT 11010, 'NS_viv', 'NS_vi', NULL, 'lineedit', 'Память, внимание, интеллект' , NULL UNION 
SELECT 11020, 'NS_vie', 'NS_vi', NULL, 'lineedit', 'Эмоциональная сфера' , NULL UNION 
SELECT 11030, 'NS_viso', 'NS_vi', NULL, 'lineedit', 'Сон' , NULL UNION 
SELECT 11040, 'NS_vid', 'NS_vi', NULL, 'lineedit', 'Высшие корковые функции (дополнительно)' , 'дополнительно' UNION 
SELECT 11050, 'NS_d', 'NSall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 12020, 'DAMOC', 'DAall', NULL, 'lineedit', 'Рот и полость рта' , NULL UNION 
SELECT 12030, 'DADH', 'DAall', NULL, 'lineedit', 'Состояние зубов' , NULL UNION 
SELECT 12040, 'DAT', 'DAall', NULL, 'combobox', 'Язык' , NULL UNION 
SELECT 12050, 'DAZ', 'DAall', NULL, 'lineedit', 'Зев' , NULL UNION 
...
SELECT 12110, 'DAAd4', 'DAall', NULL, 'lineedit', 'Окружность живота на уровне пупка' , NULL UNION 
SELECT 12120, 'NS_to', 'DAall', NULL, 'lineedit', 'Тошнота' , NULL UNION 
...
SELECT 12250, 'DAlogo', 'DASlog', NULL, 'lineedit', 'Симптомы (дополнительно)' , 'дополнительно' UNION 
...
SELECT 12280, 'DALPer1t', 'DALPer', NULL, 'lineedit', 'по l. mediaclavicularis dextra' , NULL UNION 
SELECT 12290, 'DALPer2t', 'DALPer', NULL, 'lineedit', 'по l. mediasternalis anterior' , NULL UNION 
SELECT 12300, 'DALPer3t', 'DALPer', NULL, 'lineedit', 'по l. costalis sinistra:' , NULL UNION 
SELECT 12310, 'DALPal', 'DAL', NULL, 'container', 'пальпаторно' , NULL UNION 
SELECT 12320, 'DALPalC', 'DALPal', NULL, 'lineedit', 'Консистенция' , NULL UNION 
SELECT 12330, 'DALPalT', 'DALPal', NULL, 'lineedit', 'Поверхность' , NULL UNION 
SELECT 12340, 'DALPalP', 'DALPal', NULL, 'lineedit', 'Болезненность' , NULL UNION 
...
SELECT 12390, 'DALo', 'DAL', NULL, 'lineedit', 'Печень (дополнительно)' , 'дополнительно' UNION 
SELECT 12400, 'DAS', 'DAall', NULL, 'container', 'Селезенка' , NULL UNION 
SELECT 12410, 'DASPal', 'DAS', NULL, 'lineedit', 'пальпаторно' , NULL UNION 
SELECT 12420, 'DASPer', 'DAS', NULL, 'lineedit', 'перкуторно' , NULL UNION 
SELECT 12430, 'DASo', 'DAS', NULL, 'lineedit', 'Селезенка (дополнительно)' , 'дополнительно' UNION 
...
SELECT 12520, 'DAd', 'DAall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 14020, 'UGSL', 'UGSall', NULL, 'lineedit', 'Осмотр поясницы' , NULL UNION 
SELECT 14030, 'UGSPK', 'UGSall', NULL, 'lineedit', 'Пальпация почек' , NULL UNION 
...
SELECT 14070, 'UGSGS', 'UGSall', NULL, 'lineedit', 'Гинекологическое исследование' , NULL UNION 
SELECT 14080, 'UGSd', 'UGSall', NULL, 'lineedit', 'Дополнительно', NULL ; 
...
SELECT 15040, 'FECd', 'FECall', NULL, 'lineedit', 'Дополнительно', NULL ; 
