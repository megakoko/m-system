...
SELECT 7770, 'CVSCE', 'CVSall', NULL, 'container', 'Окружность конечностей' , '' UNION 
...
SELECT 9970, 'NS_cnpoda', 'NS_cnpod', NULL, 'lineedit', 'Атрофия (гипотрофия) и фибриллярные подергивания в мышцах языка' , '' UNION 
